...
* `str_comb_intv` takes in continuous variables and outputs an estimate of centrality (your choice), along with an interval estimate (your choice), rounded to a number of digits (your choice), and seperated by a given delimeter (also your choice!). 
...
* `str_comb_NA` works similarly to `str_comb_prop` except it works for counting tallying missingness. 
